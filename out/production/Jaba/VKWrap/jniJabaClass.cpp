...
static void JavaCPP_VKWrap_JabaClass_deallocate(void *p) { delete (VKWrap::JabaClass*)p; }
...
JNIEXPORT int JavaCPP_init(int argc, const char *argv[]) {
    ...
    options[0].optionString = (char*)"-Djava.class.path=javacpp.jar;.;out/production/Jaba/VKWrap/VkDeviceCreateInfoWrap.class";
...
JNIEXPORT void JNICALL Java_VKWrap_JabaClass_allocate(JNIEnv* env, jobject obj) {
    jthrowable exc = NULL;
    try {
        VKWrap::JabaClass* rptr = new VKWrap::JabaClass();
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_VKWrap_JabaClass_deallocate);
    } catch (...) {
...
JNIEXPORT void JNICALL Java_VKWrap_JabaClass_createDevice(JNIEnv* env, jobject obj, jlong arg0) {
    VKWrap::JabaClass* ptr = (VKWrap::JabaClass*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
    ...
    jthrowable exc = NULL;
    try {
        ptr->createDevice((const VkDeviceCreateInfo*)arg0);
    } catch (...) {
        exc = JavaCPP_handleException(env, 7);
    }
