...
static void JavaCPP_VKWrap_VkDeviceCreateInfoWrap_deallocate(void *p) { delete (VkDeviceCreateInfo*)p; }

static const char* JavaCPP_members[8][2] = {
        { NULL },
        { NULL },
        { NULL },
        { NULL },
        ...
        { "sizeof" },
        { NULL } };
static int JavaCPP_offsets[8][2] = {
        { -1 },
        { -1 },
        { -1 },
        { -1 },
...
JNIEXPORT void JNICALL Java_VKWrap_VkDeviceCreateInfoWrap_allocate(JNIEnv* env, jobject obj) {
    jthrowable exc = NULL;
    try {
        VkDeviceCreateInfo* rptr = new VkDeviceCreateInfo();
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_VKWrap_VkDeviceCreateInfoWrap_deallocate);
    } catch (...) {
